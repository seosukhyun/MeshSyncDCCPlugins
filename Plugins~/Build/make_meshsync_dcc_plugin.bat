...
SET CMAKE_BUILD_ARGS=-DBUILD_MAYA_ALL=OFF -DBUILD_3DSMAX_ALL=OFF -DBUILD_BLENDER_ALL=ON -DBUILD_MOTIONBUILDER_ALL=OFF -DBUILD_METASEQUOIA_ALL=OFF -DBUILD_MODO_ALL=OFF
